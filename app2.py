...
#Tweet Graph
    fig = px.line(dff, x="Datetime", y=dffn['Count of {}'.format(y)], hover_data = "Text", title = "Trump's Tweet and Twitter Sentiment") #Add another sub description below
...
#Key Word Bar Graph
    ...
    fig3 = px.bar(result, x="Datetime", y="index", color="key word", title="Racial Slurs used on Twitter")
